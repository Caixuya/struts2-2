		...
		<div class="box">
			...
			<s:form action="login" method="post">
				<div class="infos">
					...
					<!-- 点击登录按钮时，浏览器做出怎样的行为？点击登录时，提交表单login?username=XXX&password=XXX，另外<a href="login?username=XXX&password=XXX"> 和window.location.href="login?username=XXX&password=XXX"这两种方式也可以提交表单-->
				</div>
			</s:form>
		</div>
	</div>
